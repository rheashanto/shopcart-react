        ...
        <div className="navbar__inner">
          ...
          <ul className="navbar__links">
            ...
            {['Men', 'Women', 'Accessories', 'Shoes'].map((cat) => (
              <li key={cat}>
                <NavLink to={`/shop?category=${cat.toLowerCase()}`} className="navbar__link">{cat}</NavLink>
              </li>
            ))}
          </ul>
          ...
          <div className="navbar__search">
            ...
            <input type="search" className="navbar__search-input" placeholder="Search products..." aria-label="Search products" />
          </div>
